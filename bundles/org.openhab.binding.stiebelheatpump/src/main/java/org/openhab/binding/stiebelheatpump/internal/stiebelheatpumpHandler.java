...
public class stiebelheatpumpHandler extends BaseThingHandler {
    ...
    private final Logger logger = LoggerFactory.getLogger(stiebelheatpumpHandler.class);

    private @Nullable stiebelheatpumpConfiguration config;
    ...
    public void initialize() {
        ...
        config = getConfigAs(stiebelheatpumpConfiguration.class);
